...
        [Tooltip("Enables the culling distance calculations.")]
        ...
        [Tooltip("Clear color for blur. It may create good visuals if you wanna blur a an object with that color!")]
        public Color DepthBlurClearColor = new Color(0, 0, 0, 0);
        [Range(0, 30)]
        ...
        CameraManager.CameraSettings GetCameraSettings()
        {
            return new CameraManager.CameraSettings
            {
                ...
                DepthBlurClearColor = DepthBlurClearColor,
...
            int depth = 24;
    ...
    public class CameraManager : ManagerBase
    {
        ...
        public struct CameraSettings
        {
            ...
            public Color DepthBlurClearColor { get; set; }
...
            }
            ...
            else if (_settings.EnableDepthBlur)
            {
                //EnableDepthBlur mixes not nice with the skybox! so we disable it too!
                _mirrorCamera.clearFlags = CameraClearFlags.Color;
                _mirrorCamera.backgroundColor = _settings.DepthBlurClearColor; //we wll clean black on shader!!!
            }
            else
            {
