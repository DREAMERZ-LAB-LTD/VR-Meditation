...
namespace AkilliMum.SRP.Mirror
{
    ...
    public class MirrorManagerEditor : Editor
    {
        ...
        SerializedProperty DepthBlurClearColor;
        ...
        void OnEnable()
        {
            ...
            DepthBlurClearColor = serializedObject.FindProperty("DepthBlurClearColor");
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (MenuCommon)
            {
                ...
                if (EnableDepthBlur.boolValue)
                {
                    ...
                    EditorGUILayout.PropertyField(DepthBlurClearColor, new GUIContent { text = space + "Clear Color" });
